	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.trucos}">
				<li class="fieldcontain">
					<span id="trucos-label" class="property-label"><g:message code="usuario.trucos.label" default="Trucos" /></span>
					
						<g:each in="${usuarioInstance.trucos}" var="t">
						<span class="property-value" aria-labelledby="trucos-label"><g:link controller="truco" action="show" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
						</g:each>
