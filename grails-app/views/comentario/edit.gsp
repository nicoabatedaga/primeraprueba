...
<html>
	...
	<body>
		<a href="#edit-comentario" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-comentario" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:comentarioInstance, action:'update']" method="PUT" >
